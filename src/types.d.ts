interface ChatbotConfig {
  ...
  */
  ...
  answerEvents?: {
     ...
     * 点赞按钮被点击时触发
     */
    praiseClick?: (info:AnswerInfo) => void;
    /**
     * 踩按钮被点击时触发
     */
    blameClick?: (info:AnswerInfo) => void;
    /**
     * 收藏被点击时出发
     */
    collectClick?: (info:AnswerInfo) => void;
    /**
     * copy被点击时出发
     */
    copyClick?: (info:AnswerInfo) => void;
  };
}

interface AnswerInfo<AiMsg> {
  content: AiMsg[];
